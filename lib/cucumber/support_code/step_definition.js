var StepDefinition = function(regexp, code) {
  ...
  var self = {
    ...
    invoke: function invoke(stepName, world, stepAttachment, callback) {
      ...
      codeCallback.failure = function failure(reason) {
        throw Cucumber.Runtime.FailingStepException(reason);
      };
      ...
      try {
        ...
        else if (exception instanceof Cucumber.Runtime.FailingStepException)
